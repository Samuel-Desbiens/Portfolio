...
public class ExplosionUpgradeBehaviour : MonoBehaviour
{
    private const float maxStayTimer = 0.75f; //Diff 1 avec celle de base ...
    private float timerLeft;

    private const float baseScale = 20;

    private const float scaling = 1.02f; //Diff 2 avec celle de base ...
