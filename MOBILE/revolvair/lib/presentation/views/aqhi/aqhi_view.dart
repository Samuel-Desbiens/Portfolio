...
import 'package:resolvair/presentation/views/aqhi/aqhi_viewmodel.dart';
import 'package:resolvair/presentation/widgets/details_screen_widget.dart';
import 'package:stacked/stacked.dart';

class AqhiView extends StatelessWidget {
  const AqhiView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<AqhiViewModel>.reactive(
      viewModelBuilder: () => AqhiViewModel(),
